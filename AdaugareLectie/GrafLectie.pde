class GrafLectie extends Obj{
	...
	GrafLectie(PVector pos, color c, float w, float h, float anim){
		...
		btns.add(new ToggleBtn(new PVector(addPos.x + basePos.x + 4 * w/6, addPos.y + basePos.y), color(51,133,198), w/6, h/7, 0.2, color(66,121,163), color(14,154,167), "Delete edge", 5));
		btns.add(new ToggleBtn(new PVector(addPos.x + basePos.x + 4 * w/6, addPos.y + basePos.y), color(51,133,198), w/6, h/7, 0.2, color(66,121,163), color(14,154,167), "Delete point", 6));
