    ...
    if(hub.gameSelected!=0) {  //GAMES
      ...
      switch(currentModule) {
        ...
        case 11:{//deconectare
          ...
          menu2.tabs[0].sub[0] = new SubMenu("Login", 5, menu2.tabs[0].seekPos, menu2.tabs[0].seekCol, menu2.tabs[0].seekSize, menu2.tabs[0].animSpd, menu2.tabs[0].seekW, 2*menu2.tabs[0].h/3);
          menu2.tabs[0].sub[1] = new SubMenu("Register", 6, menu2.tabs[0].seekPos, menu2.tabs[0].seekCol, menu2.tabs[0].seekSize, menu2.tabs[0].animSpd, menu2.tabs[0].seekW, 2*menu2.tabs[0].h/3);
